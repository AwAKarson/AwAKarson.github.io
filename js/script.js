...
function beveragesClickRadio(a, b) {
    ...
    targetDiv = document.querySelector('.preview.active div div #' + CSS.escape(b))
    if (targetDiv.id[0] != "h" && targetDiv.id[0] != "k" && (targetDiv.id[0] != "s" && targetDiv.id[1] != "o")) {
    ...
    document.querySelectorAll('#' + b).forEach(div => {
        if (div.id[0] != "h" && div.id[0] != "k" && (div.id[0] != "s" && div.id[1] != "o")) {
    ...
    if (document.querySelector('.preview.active div .beveragesDiv') != null) {
        ...
        document.querySelectorAll('.allBeveragesCustomization input').forEach(checkbox => {
            if (checkbox.checked == true) {
                ...
                if (checkbox.id[0] != "h" && checkbox.id[0] != "k" && (checkbox.id[0] != "s" && checkbox.id[1] != "o")) {
