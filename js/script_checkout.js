...
function checkOut() {
    ...
    if (getAllItems != "") {
        ...
        getMemberJSON[targetMemberRow].MemberPoints = getMemberJSON[targetMemberRow].MemberPoints + getTotalPrice
        console.log(targetMemberRow)
        localStorage.setItem("memberJSON", JSON.stringify(getMemberJSON))
        localStorage.setItem("productPrice", getTotalPrice)
